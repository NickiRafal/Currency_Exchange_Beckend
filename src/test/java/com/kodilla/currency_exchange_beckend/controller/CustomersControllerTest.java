...
public class CustomersControllerTest {
    ...
    public void getAllCustomers_ShouldReturnListOfCustomers() {
        // Given
        List<CustomersDTO> mockCustomers = Collections.singletonList(new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(100.00), LocalDate.of(2023,05,06)));
        when(customersService.getAllCustomers()).thenReturn(mockCustomers);
        when(modelMapper.map(any(), eq(CustomersDTO.class))).thenReturn(new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(100.00), LocalDate.of(2023,05,06)));
    ...
    public void createCustomer_ShouldReturnCreatedCustomer() {
        // Given
        CustomersDTO customerDTO = new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(100.00), LocalDate.of(2023,05,06));
        CustomersDTO createdCustomerDTO = new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(100.00), LocalDate.of(2023,05,06));
    ...
    public void updateCustomer_ShouldReturnUpdatedCustomer() {
        ...
        Long customerId = 1L;
        CustomersDTO customerDTO = new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(100.00), LocalDate.of(2023,05,06));
        CustomersDTO updatedCustomerDTO = new CustomersDTO(1L,"Rafal","Nicki","test@test.com", BigDecimal.valueOf(120.00), LocalDate.of(2023,05,06));
